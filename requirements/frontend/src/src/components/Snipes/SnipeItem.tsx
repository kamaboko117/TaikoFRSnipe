...
import { verbList } from "./SnipeFeedItem";
  ...
  return (
    <div className="snipe-item">
      ...
      <div className="beatmap-snipe">
        <span className="beatmap-sniper">{snipe.sniper.name}</span>
        {snipe.victim ? (
          <>
            <span>
              {" "}
        ...
        <span className="beatmap-snipe-date">
          {
            ...
            Math.floor(
              (Date.now() - Date.parse(snipe.timestamp.toString())) /
                1000 /
                60 /
                60 /
                24
              ...
              : Math.floor(
                  (Date.now() - Date.parse(snipe.timestamp.toString())) / 1000
                ) + " seconds"
          }{" "}
          ago
        </span>
